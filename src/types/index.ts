...
/** Предустановленные кнопки действия для визиток типа «Нетворкинг». */
export const NETWORKING_ACTION_OPTIONS = [
  "Не использовать",
  "Оплатить",
  "Перевести",
  "Заказать звонок",
...
/** Значение для варианта «Свой вариант» в выпадающем списке. */
export const CUSTOM_ACTION_VALUE = "__custom__";
